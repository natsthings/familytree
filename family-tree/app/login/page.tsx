...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      {/* Background tree rings decoration */}
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-display text-4xl text-[var(--parchment)] mb-2">
            Family Tree
          </h1>
          <p className="text-[var(--parchment-dim)] font-body italic text-sm">
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-8">
          <h2 className="font-display text-xl text-[var(--parchment)] mb-6">
            Sign in
          </h2>
          ...
          <p className="text-center text-sm font-body text-[var(--parchment-dim)] mt-6">
            No account yet?{' '}
            <Link href="/register" className="text-[var(--gold)] hover:text-[var(--gold-bright)] transition-colors">
              Create one
            </Link>
          </p>
        </div>
